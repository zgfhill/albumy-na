...
def index():
	...
	return render_template('admin/index.html', user_count=user_count, photo_count=photo_count, tag_count=tag_count, comment_count=comment_count, locked_user_count=locked_user_count, blocked_user_count=blocked_user_count, reported_comments_count=reported_comments_count, reported_photos_count=reported_photos_count)
...
def manage_photo(order):
	...
	return render_template('admin/manage_photo.html', order_rule=order_rule, pagination=pagination, photos=photos)
...
def manage_user():
	...
	moderator = Role.query.filter_by(name='Moderate').first()
